                ...
                <div class="row footer-p">
                    <div class="col-lg-8 mt-lg-0 mt-4 pr-lg-5">
                        <div class="d-sm-flex align-items-center top-footer-content mb-5">
                            <a class="logo d-flex align-items-center" href="index.php"><img src="./assets/images/Logo.png" width="150" alt=""></a>
                        ...
                        <div class="row footer-grids pt-4">
                            ...
                            <div class="col-sm-3 col-6 column pl-sm-0">
                                <ul class="footer-gd-16">
                                    <li><a href="about.php"><i class="fa fa-angle-right" aria-hidden="true"></i>About
                                            Us</a></li>
                                </ul>
                            </div>
                            <div class="col-sm-3 col-6 column pl-sm-0">
...
<div class="col-lg-4 col-md-7 column mt-lg-0 mt-4">
                ...
                <div class="below-section mt-5 text-center">
                    <p class="copy-text">@ 2022 All rights reserved. <a href="https://www.508bytes.com/">
                            508Bytes</a>
                    </p>
                </div>
            </div>
    ...
    <script>
        ...
        const textArray = ["Designer's", "Developer's", "Creator's", "Dreamer's"];
